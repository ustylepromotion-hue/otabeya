globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-vLx9Xps2.js","assets/layout-segment-context-JwF1TPeu.js"];
...
function getDraftSecret() {
	return "1115aa0f-cfc6-4bd9-8b13-8b93ddee92b4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2f38f423-396f-41f8-b245-aacf442699dd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2f38f423-396f-41f8-b245-aacf442699dd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2f38f423-396f-41f8-b245-aacf442699dd",
		rootBoundaryId
	});
}
/**
