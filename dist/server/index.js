globalThis.__VINEXT_LAZY_CHUNKS__ = ["otby/77/assets/page-vLx9Xps2.js","otby/77/assets/layout-segment-context-gSIyQn-1.js"];
...
function getDraftSecret() {
	return "499904f6-403b-4e9e-87ec-fefe763e40c1";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "131f8d25-e3fc-4f50-baf2-90d601bd6cfd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "131f8d25-e3fc-4f50-baf2-90d601bd6cfd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "131f8d25-e3fc-4f50-baf2-90d601bd6cfd",
		rootBoundaryId
	});
}
/**
