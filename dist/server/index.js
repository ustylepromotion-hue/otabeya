...
function getDraftSecret() {
	return "5c3de0af-5ec8-4db5-b090-ce3f48292ca4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b688981f-b5fe-4e59-90c3-d20ef0dda081";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b688981f-b5fe-4e59-90c3-d20ef0dda081") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b688981f-b5fe-4e59-90c3-d20ef0dda081",
		rootBoundaryId
	});
}
/**
