...
function getDraftSecret() {
	return "9bcee871-7e6a-47fa-915f-b87d0f0603c1";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "00bf4085-4c96-4f08-b641-fac55a0a6a9e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "00bf4085-4c96-4f08-b641-fac55a0a6a9e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "00bf4085-4c96-4f08-b641-fac55a0a6a9e",
		rootBoundaryId
	});
}
/**
...
async function GET$4(_request, context) {
...
//#endregion
//#region app/api/formtest/route.ts
...
var routes = [
	...
	},
	{
		...
		ids: {
			"route": "route:/api/formtest",
			"page": null,
			"routeHandler": "route-handler:/api/formtest",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/formtest",
		patternParts: ["api", "formtest"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: null,
